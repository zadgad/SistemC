@extends('layouts.appl', ['activePage' => 'user-management', 'titlePage' => __('Editar Usuario')])
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row ">
                    ...
                    <input type="text" name="Login" class="form-control" placeholder="{{ __('Login') }}" value="{{ old('last_ape') }}" maxlength="20" minlength="4" required>
                </div>
                @if ($errors->has('name'))
                  <div id="name-error" class="error text-danger pl-3" for="name" style="display: block;">
                    <strong>{{ $errors->first('name') }}</strong>

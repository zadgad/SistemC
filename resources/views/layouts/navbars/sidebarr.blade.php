            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="{{route('formulario')}}" class="menu-item">Añadir Usuario</a>
                        <a href="{{route('list_ad')}}" class="menu-item">Lista de Administradores</a>
                        <a href="{{route('list_em')}}" class="menu-item">Lista de Empledos</a>
                        <a href="{{route('list')}}" class="menu-item">Lista de Ususarios</a>
                        <a href="{{route('listUs')}}" class="menu-item">Lista de Usuarios Goblal</a>
